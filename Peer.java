	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				Server myServer = new Server(sPort,person,friend);
				Client myClient = new Client(cPort,person,friend);
            ...
            System.out.println("Please enter both ports and usernames on the command line");
        }
	}
}